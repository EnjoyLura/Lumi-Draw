...
export const messageCategories: MessageCategory[] = [
  ...
  { key: "remake", title: "同款生成", icon: "✦", gradient: "linear-gradient(135deg,#A3E4CC,#7DD4B0)", color: "#7dd4b0" },
  { key: "follow", title: "新粉丝", icon: "♙", gradient: "linear-gradient(135deg,#FFD4A8,#FFC088)", color: "#ffc088" },
  { key: "system", title: "系统通知", icon: "☷", gradient: "linear-gradient(135deg,#B4C8F5,#96B0E8)", color: "#96b0e8" },
  { key: "service", title: "官方客服", icon: "☏", gradient: "linear-gradient(135deg,#C8B5E8,#B09DD8)", color: "#b09dd8" }
];

export const messageMap: Record<MessageCategoryKey, MessageItem[]> = {
  like: [
    { user: users[2], content: "赞了你的作品「霓虹都市」", time: "2分钟前", unread: true },
    { user: users[3], content: "赞了你的作品「山水之间」", time: "1小时前", unread: true },
    { user: users[4], content: "赞了你的作品「少女与猫」", time: "3小时前", unread: false }
  ],
  favorite: [
    { user: users[3], content: "收藏了你的作品「霓虹都市」", time: "30分钟前", unread: true },
    { user: users[4], content: "收藏了你的作品「古风少女」", time: "2小时前", unread: true }
  ],
  remake: [
    { user: users[3], content: "使用了你的提示词生成了新作品", time: "3小时前", unread: true }
  ],
  follow: [
  ...
  system: [
    ...
    { content: "您的作品「霓虹都市」已通过审核", time: "2天前", unread: false },
    { content: "欢迎使用Lumi-Draw！新用户赠送100积分", time: "3天前", unread: false }
  ],
  service: [
    { content: "感谢使用Lumi-Draw，有任何问题随时联系我们", time: "3天前", unread: false },
    { content: "您好，有什么可以帮您？", time: "5天前", unread: false }
  ]
};
