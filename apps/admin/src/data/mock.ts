...
export const ENGINE_PLATFORMS: Array<import("./engineApi").EnginePlatform> = [
  {
    id: "ainb",
    name: "Ainb Image2",
    groupName: "主力",
    ...
    config: {
      ...
      statusEnabled: true,
      responseMapping: { taskIdPath: "task_id", statusPath: "data.status", progressPath: "data.progress", resultUrlPath: "data.data.data[].url", errorPath: "data.fail_reason", successValue: "SUCCESS", failureValue: "FAILURE" },
      ...
      injectModel: true,
      injectCount: true,
      requestParams: { quality: "high", response_format: "url", output_format: "png" },
      imageRequestParams: { quality: "high", input_fidelity: "high", response_format: "url" },
    ...
    linkedModelIds: ["gpt2"],
    health: { total: 28, succeeded: 27, failed: 1 },
    createdAt: "2026-08-01T00:00:00.000Z",
    updatedAt: "2026-09-01T00:00:00.000Z"
  },
  {
    id: "change2pro",
    name: "Change2Pro Banana",
    groupName: "主力",
    enabled: true,
    sort: 20,
    adapter: "gemini",
    ...
    config: {
      ...
      resolutionField: "imageSize"
    },
    apiKeyHint: "••••f10d",
    apiKeyEnv: "",
    hasEncryptedKey: true,
    linkedModelIds: ["nano"],
    health: { total: 41, succeeded: 39, failed: 2 },
    createdAt: "2026-08-01T00:00:00.000Z",
    updatedAt: "2026-09-01T00:00:00.000Z"
  },
  {
    ...
    config: {
      adapter: "async-http",
      requestMode: "async",
      baseUrl: "https://lab.example.com/v1/tasks",
      imageEndpoint: "https://lab.example.com/v1/tasks",
      queryEndpoint: "https://lab.example.com/v1/tasks/{task_id}",
      statusEnabled: true,
      responseMapping: { taskIdPath: "data.id", statusPath: "data.state", progressPath: "data.percent", resultUrlPath: "data.result.images[].url", errorPath: "data.error.message", successValue: "DONE", failureValue: "ERROR" },
      resultUrlRewriteRules: [{ sourceHost: "cdn.lab.example.com", targetHost: "cdn-lab.example.cn" }],
      textToImageEnabled: true,
      imageToImageEnabled: true,
      authMode: "bearer",
      authHeaderName: "Authorization",
      ...
      requestHeaders: {},
      queryHeaders: {},
      requestTemplate: { model: "{{model}}", input: { prompt: "{{prompt}}", aspect_ratio: "{{ratio}}", resolution: "{{resolution}}" }, callback_url: "{{callback_url}}" },
      imageRequestTemplate: { model: "{{model}}", input: { prompt: "{{prompt}}", image_urls: "{{image_urls}}" } },
      injectModel: false,
      injectCount: false,
      requestParams: {},
      imageRequestParams: {},
    ...
    apiKeyHint: "",
    apiKeyEnv: "LAB_TASK_API_KEY",
    hasEncryptedKey: false,
    linkedModelIds: ["flux", "sdxl"],
