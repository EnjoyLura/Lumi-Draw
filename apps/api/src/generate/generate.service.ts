...
const QUICK_PROVIDER_FAILURE_MS = 15_000;
...
export function userFacingGenerateError(errorMessage: string) {
  ...
  if (/暂无可用产能|no available capacity|capacity unavailable|insufficient capacity/.test(message)) return "当前 4K 生成通道繁忙，请稍后重试或切换其他模型";
